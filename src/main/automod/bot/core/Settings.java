...
import automod.bot.data.StringValue;
import automod.bot.ExitStatus;
import automod.bot.Main;
import automod.bot.core.settings.GuildSetting;
import automod.bot.core.settings.IGuildSettingType;
import automod.bot.core.settings.types.BooleanSettingType;
import automod.bot.core.settings.types.StringLengthSettingType;
import automod.bot.data.GuildBool;
...
public class Settings {
    ...
    private static void init() {
        Reflections reflections = new Reflections("automod.bot.settings");
