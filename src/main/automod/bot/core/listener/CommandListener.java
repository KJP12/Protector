package automod.bot.core.listener;

import automod.bot.core.Settings;
import automod.bot.Config;
import automod.bot.ExitStatus;
import automod.bot.Main;
import automod.bot.commands.CommandCategory;
...
//    private static final ConcurrentHashMap<Long, String> prefixes = new ConcurrentHashMap<>();
    ...
    private static void collectCommands() {
        Reflections reflections = new Reflections("automod.bot.commands");
